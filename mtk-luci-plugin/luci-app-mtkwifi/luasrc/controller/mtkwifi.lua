...
function index()
    ...
    entry({"admin", "network", "wifi"}, template("admin_network/mtk_wifi_overview"), _("Wireless"), 15)
    entry({"admin", "network", "wifi", "dev_cfg_view"}, template("admin_network/mtk_wifi_dev_cfg")).leaf = true
    ...
    entry({"admin", "network", "wifi", "vif_cfg_view"}, template("admin_network/mtk_wifi_vif_cfg")).leaf = true
    entry({"admin", "network", "wifi", "vif_cfg"}, call("vif_cfg")).leaf = true
    entry({"admin", "network", "wifi", "vif_add_view"}, template("admin_network/mtk_wifi_vif_cfg")).leaf = true
    ...
    entry({"admin", "network", "wifi", "apcli_cfg_view"}, template("admin_network/mtk_wifi_apcli")).leaf = true
